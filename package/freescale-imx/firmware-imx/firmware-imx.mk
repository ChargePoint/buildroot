...
ifeq ($(BR2_PACKAGE_FIRMWARE_IMX_LPDDR4_PMU_TRAIN),y)
FIRMWARE_IMX_DDRFW_DIR = $(@D)/firmware/ddr/synopsys

define FIRMWARE_IMX_INSTALL_IMAGE_DDR_FW
	# Create padded versions of lpddr4_pmu_train_* and generate lpddr4_pmu_train_fw.bin.
	...
	# the binary dir.
	cp $(FIRMWARE_IMX_DDRFW_DIR)/lpddr4_pmu_train_*.bin $(BINARIES_DIR)/
endef
endif
...
define FIRMWARE_IMX_INSTALL_IMAGE_DDR_FW
	# Create padded versions of lpddr4_* and generate lpddr4_fw.bin.
	...
	# sure that U-Boot can access all available files copy them to
	# the binary dir.
	cp $(FIRMWARE_IMX_DDRFW_DIR)/lpddr4_*_fw.bin $(BINARIES_DIR)/
endef
endif
