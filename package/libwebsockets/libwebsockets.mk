...
LIBWEBSOCKETS_DEPENDENCIES += systemd
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_SDEVENT=ON
else
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_SDEVENT=OFF
endif
...
ifeq ($(BR2_PACKAGE_LIBWEBSOCKETS_NETLINK),y)
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_NETLINK=1
else
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_NETLINK=0
endif

ifeq ($(BR2_PACKAGE_LIBWEBSOCKETS_ASYNCDNS),y)
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_SYS_ASYNC_DNS=ON
else
LIBWEBSOCKETS_CONF_OPTS += -DLWS_WITH_SYS_ASYNC_DNS=OFF
endif
